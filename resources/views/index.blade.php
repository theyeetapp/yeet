...
@section('body')
    <div class='quicksand'>
        ...
        t<div class='grid grid-cols-12 px-6 sm:px-16 md:px-24 bmd:px-6 py-20 sm:mt-16 bmd:mt-16 bg-yeet-blue text-white'>
        ...
        <div class='py-8 sm:py-12 md:py-24 px-8 sm:px-12 md:px-20 lg:pl-28 lg:pr-24 bg-light-gray'>
            <div class='w-full bmd:px-8 flex flex-col lg:flex-row'>
                <div class='w-full mb-10 lg:mb-0 lg:w-1/2 lg:ml-5 lg:pr-10'>
                ...
                <div class='w-full text-justify sm:text-left lg:w-1/2 lg:pl-10 flex flex-col'>
                    ...
                    <div class='flex flex-col mb-4'>
                        ...
                        <p class='m-0 text-justify'>From your stocks or cryptocurrencies tabs in Yeet, find stocks or crypto you have in your portfolio or simply want to monitor and subscribe to them.</p>
                    </div>
                    <div class='flex flex-col mb-4'>

    ...
    <div class='quicksand'>
        <div class='hero grid grid-cols-12 pl-8 sm:pl-16 md:pl-24 bmd:pl-6 bg-yeet-blue'>
            <div class='hero__content col-span-12 bmd:col-start-2 md:col-end-12 lg:col-span-5 h-full flex flex-col justify-center text-white'>
                ...
                <div class='flex'>
                    <a href='{{ route("signup") }}' class='bg-yeet-medium-blue text-white pt-3 pb-4 px-6 text-md mr-4' style='width:fit-content;'>signup</a>
        ...
        <div class='sm:pt-16 lg:pt-20 px-6 sm:px-16 md:px-24 lg:px-64'>
            <div class='flex flex-col-reverse bmd:grid bmd:grid-cols-12 col-gap-5 px-1 sm:px-10 py-16 sm:py-10 bmd:p-16 bg-white sm:shadow-md'>
                <div class='w-full bmd:col-span-6 flex flex-col justify-center lowercase bmd:pr-5'>
                    <p class='m-0 mb-2 bmd:mb-3 text-lg text-center bmd:text-left font-semibold'>What is Yeet and what can it do for you</p>
                    ...
                    have Yeet do that for you. Yeet will deliver the current share price and other relevant details of your favorite stocks and crypto
        ...
        <div class='grid grid-cols-12 px-8 sm:px-16 md:px-24 bmd:px-6 py-16 sm:py-16 lg:py-20 sm:mt-16 lg:mt-20 bg-yeet-blue text-white'>
            <div class='h-full hidden bmd:flex col-start-2 col-end-6 flex-col justify-center'>
                ...
                must be registered with him. Every morning at 8am GMT +1, he delivers roundups of all stocks and crypto currencies you are subscribed to.</p>
            ...
            <div class='h-full bmd:hidden col-span-12 flex flex-col items-center justify-center'>
                ...
                the automated stock and crypto tracking services provided by Yeet, user Telegram details
                must be registered with him. Every morning at 8am GMT +1, he delivers roundups of all stocks and crypto currencies you are subscribed to.</p>
                <a href='https://t.me/theyeetbot' class='bg-yeet-medium-blue py-4 px-6 text-white text-md' style='width:fit-content;'>YeetBot <i class='ml-2 text-sm fa fa-external-link-alt'></i></a>
            </div>
        </div>
                ...
                <div class='w-full flex flex-col lg:flex-row'>
                    ...
                    <div class='w-full text-justify sm:text-left lg:w-1/2 lg:pl-10 flex flex-col justify-center'>
                        ...
                        <div class='flex flex-col'>
                            ...
                            <p class='m-0 text-justify'>Every morning at 8am GMT +1, YeetBot via Telegram will send you the market prices of all the stocks and crypto currencies you are subscribed to.</p>
                        </div>
                    </div>
                </div>
            </div>
